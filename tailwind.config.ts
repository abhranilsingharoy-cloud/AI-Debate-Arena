  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-orange': '0 0 20px rgba(255,107,53,0.5), 0 0 60px rgba(255,107,53,0.2)',
        'glow-teal': '0 0 20px rgba(45,212,191,0.5), 0 0 60px rgba(45,212,191,0.2)',
        'clay': '4px 4px 10px rgba(0,0,0,0.5), -2px -2px 8px rgba(255,255,255,0.04)',
        'clay-hover': '6px 6px 16px rgba(0,0,0,0.6), -3px -3px 12px rgba(255,255,255,0.06)',
