...
export const TOPICS: Topic[] = [
  ...
  { id: 't11', title: 'Veganism is the only ethical diet in 2026', category: 'Ethics', description: 'Does modern veganism hold up to ethical, environmental, and practical scrutiny?', tags: ['veganism', 'ethics', 'environment'], trending: false, debates: 2892, difficulty: 'Medium' },
